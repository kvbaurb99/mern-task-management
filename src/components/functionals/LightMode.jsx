...
export default function LightMode({isDark, setIsDark}) {
  ...
  return (
    <div className={`flex w-[90%] mx-auto md:w-full justify-center mb-5 md:mb-10 ${isDark ? 'bg-[#20212C]' : null} items-center h-[50px] rounded-lg`}>
        <div className='flex gap-5 items-center'>
            ...
            <LightModeButton isDark={isDark} toggleSwitch={toggleSwitch} />
